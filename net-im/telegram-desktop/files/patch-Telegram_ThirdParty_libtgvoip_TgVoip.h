--- Telegram/ThirdParty/libtgvoip/TgVoip.h.orig	2020-05-12 12:04:12 UTC
+++ Telegram/ThirdParty/libtgvoip/TgVoip.h
@@ -8,7 +8,7 @@
...
@@ -26,11 +26,11 @@ struct TgVoipEdpointHost {
 };
...
@@ -60,59 +60,60 @@ struct TgVoipPersistentState {
...
@@ -130,11 +131,11 @@ class TgVoip { (public)
...
+        TgVoipProxy const *proxy,
 ...
 #ifdef TGVOIP_USE_CUSTOM_CRYPTO
@@ -153,6 +154,11 @@ class TgVoip { (public)
